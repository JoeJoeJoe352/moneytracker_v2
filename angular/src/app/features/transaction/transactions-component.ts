...
import { TransactionBarChartComponent } from '../statistics/transaction-bar-chart-component';
...
@Component({
    ...
    imports: [TransactionListComponent, TranslatePipe, TransactionFilter, MatCardModule, TransactionBarChartComponent],
