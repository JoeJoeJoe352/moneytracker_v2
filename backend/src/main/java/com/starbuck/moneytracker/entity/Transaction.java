...
public class Transaction {
     ...
     * todo ezt lehet meg kellene szüntetni, mert ha a price null, akkor hibára fog
     * futni és értelmezhetetlen lesz a hibaüzenet
     * 
     * @return
     */
    public BigDecimal sumDetailsCost() {
        return this.transactionDetails.stream()
                .map((detail) -> detail.getCost(this.isOutcome()))
